/*
 * @Author: seenli
 * @Date: 2021-01-02 16:18:09
 * @LastEditors: seenli
 * @LastEditTime: 2021-01-02 17:08:52
 * @FilePath: \Ch07\ch07_ex07.cpp
...
const string declquit = "quit";                 // t.kind == quit 表示 t 是一个 quit Token
