/*
 * @Author: seenli
 * @Date: 2021-01-02 17:11:33
 * @LastEditors: seenli
 * @LastEditTime: 2021-01-02 17:35:28
 * @FilePath: \Ch07\ch07_ex08.cpp
...
const string key_quit = "quit";                 // t.kind == quit 表示 t 是一个 quit Token
const string key_exit = "exit";                 // 退出关键字
const char print = ';';                         // t.kind == print 表示 t 是一个 print Token
const char help = 'h';                          // t.kind == help 介绍如何使用该计算器
