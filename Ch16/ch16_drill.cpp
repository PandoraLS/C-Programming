...
void f3() {
    ...
    // 2.6
    cout << "输入10个pairs(string, int), 由空格隔开:\n";
    // 每次输入比较麻烦, 这里使用前面的内容代替, 值为1~10
    // for (int i = 0; i < 10; ++i) {
    //     read_pair(msi);
    // }
    msi["lecture"] = 1;
