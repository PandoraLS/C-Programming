/*
 * @Author: seenli
 * @Date: 2021-01-24 12:16:08
 * @LastEditors: seenli
 * @LastEditTime: 2021-01-24 20:40:22
 * @FilePath: \Ch13\ch13_ex08.cpp
 * @Description: Programming Principles and Practice Using C++ Second Edition
 */

// Chapter 13, exercise 08: rewrite all palindrome functions to utilise the
...
istream& read_work(istream& is, char* buffer, int max) {
    is.width(max);
    is >> buffer;
    return is;
}
...
try {
    ...
    const int max = 128;
    char s2[max];
    while (read_work(cin, s2, max) && strcmp(s2, "quit")) {
        cout << s2 << " is";
