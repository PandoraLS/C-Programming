/*
 * @Author: seenli
 * @Date: 2021-01-15 20:43:59
 * @LastEditors: seenli
 * @LastEditTime: 2021-01-15 20:55:48
 * @FilePath: \Ch10\ch10_ex10.cpp
...
//------------------------------------------------------------------------------
// 定义全局变量, 这部分放在main()中会报错
string ifname = "ex10_in.txt";
ifstream ifs(ifname.c_str());
string ofname = "ex10_out.txt";
